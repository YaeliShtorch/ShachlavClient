    ...
    template: `
        ...
        <mat-dialog-content *ngIf="this.passObj.passAction==='edit'" fxLayout="column" fxLayoutAlign="center">
            ...
            <mat-form-field>
                ...
                <input type="text" matInput placeholder="{{this.passObj.passData.SiteAdress}}"
                       [(ngModel)]="this.passObj.passData.SiteAdress" required>
            </mat-form-field>
            <mat-form-field>
                <mat-label>אלמנט</mat-label>
                <input type="text" matInput placeholder="{{this.passObj.passData.Element}}"
                       [(ngModel)]="this.passObj.passData.Element" required>
            </mat-form-field>
            <mat-checkbox [(ngModel)]="this.passObj.passData.PumpNeeded" color="primary">
                <mat-label>כולל משאבה</mat-label>
            </mat-checkbox>
            <mat-form-field>
                <mat-label>סוג משאבה</mat-label>
                <mat-select #pTSelected [(ngModel)]="this.passObj.passData.PumpId">
                    <mat-option *ngFor="let pVehicle of this.pTypes"
                                [value]="pVehicle.Id">{{pVehicle.PType}}</mat-option>
                </mat-select>
            </mat-form-field>

            <mat-form-field>
                <mat-label>שעת התחלת שימוש</mat-label>
                <input type="text" matInput placeholder="{{this.passObj.passData.StartTime}}"
                       [(ngModel)]="this.passObj.passData.StartTime" required onfocusout="checkDate()">
            </mat-form-field>
            <mat-form-field>
                <mat-label>שעת סיום שימוש</mat-label>
                <input type="text" matInput placeholder="{{this.passObj.passData.EndTime}}"
                       [(ngModel)]="this.passObj.passData.EndTime" required>
            </mat-form-field>
            <mat-checkbox [(ngModel)]="this.passObj.passData.ConcreteCheck" color="primary">
                <mat-label>בדיקת בטון</mat-label>
            </mat-checkbox>

            <mat-dialog-actions>
                <mat-label style="color:red">שים לב בעת שמירה תאריך ההזמנה ישתנה לתאריך של היום וכן אנו צריכים לאשר את
                    ההזמנה מחדש*.
                </mat-label>
